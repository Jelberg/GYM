...
public class PruebaComandoEliminarMedida {
    ...
    public void pruebaUsuarioInexistente(){
        _progreso_medida = new Progreso_Medida(0,"Biceps");
        _comando = FabricaComando.instanciaEliminarMedida(_progreso_medida);
        _comando.ejecutar();
        _respuesta = _comando.obtenerRespuesta();
    ...
    public void pruebaTipoErroneo(){
        _progreso_medida = new Progreso_Medida(1,"Carro");
        _comando = FabricaComando.instanciaEliminarMedida(_progreso_medida);
        _comando.ejecutar();
        _respuesta = _comando.obtenerRespuesta();
        Assert.assertNull(_respuesta);
